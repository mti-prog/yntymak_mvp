...
class _ServiceScreenState extends State<ServiceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final offers = _filter(provider.offers);
    final isGrid = provider.isServicesGrid;
    context.watch<LocaleProvider>();

    final cats = AppLocalizations.categories(context, 'service');
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    AppLocalizations.tr(context, 'services_title'),
                  ...
                  IconButton(
                    onPressed: () => provider.toggleServicesGrid(),
                    icon: Icon(
                      isGrid
            ...
            _buildSearchBar(AppLocalizations.tr(context, 'search_services')),
                  ...
                  : NotificationListener<ScrollNotification>(
                      ...
                      child: RefreshIndicator(
                        ...
                        child: offers.isEmpty
                            ...
                            : isGrid
                            ? _buildGrid(offers, provider.isLoadingMore)
                            : _buildList(offers, provider.isLoadingMore),
                      ),
                    ),
            ),
          ],
