...
class _CharityScreenState extends State<CharityScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final items = _filter(provider.charityPosts);
    final isGrid = provider.isCharityGrid;
    context.watch<LocaleProvider>();

    final cats = AppLocalizations.categories(context, 'charity');
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    AppLocalizations.tr(context, 'charity_title'),
                  ...
                  IconButton(
                    onPressed: () => provider.toggleCharityGrid(),
                    icon: Icon(
                      isGrid
            ...
            _buildSearchBar(AppLocalizations.tr(context, 'search_charity')),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => const AddPostScreen(type: PostType.charity),
            ),
          );
        },
